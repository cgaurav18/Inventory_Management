<%@page import="com.model.Logsprocess"%>
...
<table class="table"> <thead class="thead-dark">
  ...
  <% 
  List<Logsprocess> logsprocess=(List<Logsprocess>)request.getAttribute("logsprocess");
  for(Logsprocess rm: logsprocess)
  {
  %>
  <tr bgcolor="white">
    <td><font color="black"><%=rm.getId() %></font></td>
    <td><font color="black"><%=rm.getDate() %></font></td>
    <td><font color="black"><%=rm.getIssuer_name() %></font></td>
    <td><font color="black"><%=rm.getItemid() %></font></td>
    <td><font color="black"><%=rm.getName() %></font></td>
     <td><font color="black"><%=rm.getQuantity() %></font></td>
  </tr>
  <%} %>
