...
<div class="grid-container">
   ...
   <main class="main">
       ...
       <form method="post" action="rawadd" id="form" class="validate">
    <div class="form-field">
      <label for="full-name">Enter ID</label>
      <input type="text" name="id" id="full-name" placeholder="" required />
    </div>
    <div class="form-field">
      <label for="email-input">Enter Name</label>
      <input type="text" name="name" id="email-input" placeholder="" required />
    </div>
    <div class="form-field">
      <label for="password-input">Enter Quantity</label>
      <input type="text" name="quantity" id="password-input" required />
    </div>
    <div class="form-field">
        <label for="password-input">Enter Unit</label>
        <input type="text" name="unit" id="password-input" required />
      </div>
      <div class="form-field">
        <label for="password-input">Cost per Unit</label>
        <input type="number" name="cost" id="password-input" required />
      </div>
    <div class="form-field">
      <label for=""></label>
