...
<div class="grid-container">
   ...
   <main class="main">
       ...
       <div class="main-header__heading"><center><h1>Hello User</h1></center>
	  <form method="post" action="insertQ" id="form" class="validate">
    <div class="form-field">
      <label for="full-name">Enter Quantity</label>
      <input type="text" name="quantity" id="full-name" placeholder="" required />
    </div>
