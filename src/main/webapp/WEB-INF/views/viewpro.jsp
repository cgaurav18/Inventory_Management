<%@page import="com.model.ProcessMaterial"%>
...
<table class="table"> <thead class="thead-dark">
  ...
  <tr bgcolor="white">
    ...
    <td><font color="black"><%=rm.getUnit() %></font></td>
    <td><font color="black"><%=rm.getCost() %></font></td>
    <td><a href="deletepro/<%=rm.getId() %>">Delete</a></td>
     <td><a href="updateP?id=<%=rm.getId() %>">Update</a></td>
     <td><a href="issueP?id=<%=rm.getId() %>&name=<%=rm.getName()%>">Issue</a></td>
  </tr>
  <%} %>
